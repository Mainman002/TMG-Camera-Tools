...
classes = (
    ...
    OBJECT_PT_TMG_Passes_Panel_Filter,
    ...
    OBJECT_PT_TMG_Render_Panel_S_Denoising_Render,
    OBJECT_PT_TMG_Render_Panel_S_Denoising_Viewport,
    OBJECT_PT_TMG_Render_Panel_Sampling_Samples, 
    OBJECT_PT_TMG_Render_Panel_Cycles_Sampling_Samples, 
    OBJECT_PT_TMG_Render_Panel_Cycles_Sampling_Samples_Render,
    OBJECT_PT_TMG_Render_Panel_Cycles_Sampling_Samples_Viewport,
    ...
    OBJECT_PT_TMG_Scene_Effects_Panel_Post_Processing,
